...
const Edit = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    label: anonymousVoting ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Prevent duplicate votes', 'poll-creator') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Allowed one response per computer', 'poll-creator'),
    help: anonymousVoting ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('If checked, users can only vote once using browser storage. If unchecked, users can vote unlimited times (truly anonymous).', 'poll-creator') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('If checked, only one response per computer will be allowed (tracked by IP address).', 'poll-creator'),
    checked: allowedPerComputerResponse,
    onChange: allowedPerComputerResponse => setAttributes({
      allowedPerComputerResponse
    })
  }), anonymousVoting && allowedPerComputerResponse && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
