...
const Edit = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }), confirmationMessageType === 'view-result' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextareaControl, {
    value: viewResultconfirmationMessage || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Thanks for voting!', 'poll-creator'),
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('View result message text', 'crowdsignal-forms'),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Thanks for voting!', 'poll-creator'),
    onChange: viewResultconfirmationMessage => setAttributes({
      viewResultconfirmationMessage
    })
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Require login to vote', 'poll-creator'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('When enabled, only logged-in users can vote. Duplicate prevention uses user account instead of IP or browser storage.', 'poll-creator'),
    checked: requireLogin,
    onChange: requireLogin => setAttributes({
      requireLogin
    })
  }), requireLogin && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextareaControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Login required message', 'poll-creator'),
    value: requireLoginMessage || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Please log in to vote.', 'poll-creator'),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Please log in to vote.', 'poll-creator'),
    onChange: requireLoginMessage => setAttributes({
      requireLoginMessage
    })
  }), requireLogin && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Custom login URL', 'poll-creator'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Leave empty to use the default WordPress login page. Useful for third-party login plugins.', 'poll-creator'),
    value: requireLoginUrl || '',
    placeholder: "https://",
    onChange: requireLoginUrl => setAttributes({
      requireLoginUrl
    })
  }), requireLogin && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('When not logged in, show:', 'poll-creator'),
    value: requireLoginAction || 'hide',
    options: [{
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Login message (hide the poll)', 'poll-creator'),
      value: 'hide'
    }, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Poll with results + login popup on vote', 'poll-creator'),
      value: 'popup'
    }],
    onChange: requireLoginAction => setAttributes({
      requireLoginAction
    })
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.CheckboxControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Enable Anonymous Voting', 'poll-creator'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('When enabled, no personal data (IP, location, user agent) will be collected. GDPR compliant.', 'poll-creator'),
    checked: anonymousVoting,
    onChange: anonymousVoting => setAttributes({
      anonymousVoting
    })
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.CheckboxControl, {
    label: requireLogin ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('One vote per user', 'poll-creator') : anonymousVoting ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Prevent duplicate votes', 'poll-creator') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Allowed one response per computer', 'poll-creator'),
    help: requireLogin ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('If checked, each logged-in user can only vote once (tracked by user account).', 'poll-creator') : anonymousVoting ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('If checked, users can only vote once using browser storage. If unchecked, users can vote unlimited times (truly anonymous).', 'poll-creator') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('If checked, only one response per computer will be allowed (tracked by IP address).', 'poll-creator'),
    checked: allowedPerComputerResponse,
    onChange: allowedPerComputerResponse => setAttributes({
      allowedPerComputerResponse
    })
  }), anonymousVoting && allowedPerComputerResponse && !requireLogin && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Storage method for duplicate prevention', 'poll-creator'),
    value: anonymousVotingMethod,
    options: [{
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Local Storage - Persistent (prevents revoting even after browser restart)', 'poll-creator'),
      value: 'localStorage'
    }, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Session Storage - Temporary (allows revoting after browser closes)', 'poll-creator'),
      value: 'sessionStorage'
    }, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Cookie - Persistent with expiration (prevents revoting for 30 days)', 'poll-creator'),
      value: 'cookie'
    }],
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Choose how to store the vote flag on user\'s browser.', 'poll-creator'),
    onChange: anonymousVotingMethod => setAttributes({
      anonymousVotingMethod
    })
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, {
    group: "styles"
