...
const Poll = {
  ...
  sanitizeHTML: function (html) {
    return (0,dompurify__WEBPACK_IMPORTED_MODULE_2__.sanitize)(html, {
      USE_PROFILES: {
        html: true
      }
    });
  ...
  submit: function (event) {
    ...
    if (anonymousVoting && allowDuplicatePrevention && Poll.hasVoted(pollId, votingMethod)) {
      Poll.addError(event.target, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('You have already voted.', 'poll-creator'));
      return;
    }
