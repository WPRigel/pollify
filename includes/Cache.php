...
class Cache {
	 ...
	 * @since 1.0.0
	 */
	protected $prefix = 'pollify_cache';
	 ...
	 * @param string $key     The cache key.
	 * @param string $group   Optional. The cache group. Default is empty.
	 * @param mixed  $fallback_valued Optional. The default value to return if the given key doesn't
	 *                        exist in the object cache. Default is null.
	 *
	 * @since  1.0.0
	 * @access public
	 *
	 * @return mixed The cached value, when available, or $fallback_valued.
	 */
	public function forget( $key, $group = '', $fallback_valued = null ) {
		$found = false;
		// Get from cache.
		$cached = $this->get_cache( $key, $group, false, $found );
	 ...
	 * @param string $key     The transient key.
	 * @param bool   $site    Should use site transients.
	 * @param mixed  $fallback_value Optional. The default value to return if the given key doesn't
	 *                        exist in transients. Default is null.
	 *
	 * @since  1.0.0
	 * @access public
	 *
	 * @return mixed The cached value, when available, or $fallback_value.
	 */
	public function cease( $key, $site = false, $fallback_value = null ) {
		// Get from transient.
		$cached = $this->get_transient( $key, $site );
